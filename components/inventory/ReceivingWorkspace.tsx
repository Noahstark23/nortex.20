...
interface ReceivingWorkspaceProps {
    ...
    onUpdate: (key: string, field: 'quantity' | 'unitCost' | 'batchNumber' | 'expiryDate', value: string) => void;
                ...
                <footer className="receiving-footer">
                    <div>
                        <p className="receiving-summary-meta">
                            Subtotal {formatMoney(p.totals.subtotal)} · IVA {formatMoney(p.totals.tax)}
                        </p>
