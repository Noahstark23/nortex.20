        ...
        <div className="flex-1 flex flex-col border-r border-slate-200 bg-white">
            ...
            {activeTab === 'NEW' ? (
                    ...
                    <div className="flex-1 overflow-y-auto p-4 grid grid-cols-2 gap-3 content-start custom-scrollbar">
                        {filteredProducts.map(product => (
                            <button 
                                ...
                                className="p-3 text-left border border-slate-200 rounded-lg hover:border-nortex-500 hover:bg-slate-50 transition-all group"
                            >
                ...
                <div className="flex-1 overflow-y-auto p-4 custom-scrollbar">
                    ...
                    {history.map(quote => (
                        <div key={quote.id} className="p-4 mb-3 border border-slate-200 rounded-xl hover:shadow-md transition-shadow bg-slate-50">
            ...
            <div className="w-96 bg-slate-50 flex flex-col border-l border-slate-200">
                    ...
                    <div className="space-y-3">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input 
                                    className="w-full pl-9 pr-3 py-2 border border-slate-200 rounded-lg text-sm focus:border-nortex-500 outline-none" 
                        ...
                        <div>
                             ...
                             <input 
                                className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm focus:border-nortex-500 outline-none" 
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-2 custom-scrollbar">
                    {cart.length === 0 ? (
                        ...
                        cart.map(item => (
                            <div key={item.id} className="flex justify-between items-center bg-white p-3 rounded border border-slate-200 text-sm">
                                <div>
                ...
                <div className="p-6 bg-white border-t border-slate-200">
                    <div className="space-y-2 text-sm mb-4">
                        ...
                        <div className="flex justify-between font-bold text-nortex-900 text-lg pt-2 border-t border-slate-100"><span>Total</span><span>${grandTotal.toFixed(2)}</span></div>
                    </div>
                    
                    <div className="grid grid-cols-2 gap-3">
                        <button className="py-3 border border-slate-300 rounded-lg font-bold text-slate-600 hover:bg-slate-50 flex items-center justify-center gap-2">
