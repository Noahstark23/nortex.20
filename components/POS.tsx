...
const POS: React.FC = () => {
  ...
  return (
    <div className="flex h-full bg-slate-100 relative">
      ...
      {lastScanFeedback && (
          <div className={`absolute top-16 left-1/2 -translate-x-1/2 z-50 px-6 py-3 rounded-xl shadow-2xl font-bold text-sm animate-in fade-in slide-in-from-top duration-200 flex items-center gap-2 ${
      ...
      {/* RIGHT: CART DRAWER */}
      <div className="w-96 bg-white border-l border-slate-200 flex flex-col shadow-xl z-10 mt-14 text-slate-800">
        <div className="p-5 border-b border-slate-100 bg-slate-50 text-slate-800">
