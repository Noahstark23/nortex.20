...
const B2BMarketplace: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-6">
      ...
      <h1 className="text-2xl font-bold text-white mb-2">Mercado B2B</h1>
      ...
      <div className="inline-flex items-center gap-2 text-xs font-bold text-amber-400 bg-amber-500/10 px-3 py-1.5 rounded-full">
