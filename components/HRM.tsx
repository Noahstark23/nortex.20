...
const HRM: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'TEAM' | 'PAYROLL' | 'LIABILITIES'>('TEAM');
                ...
                >
                    ...
                    {totalPasivo > 0 && (
                        <span className={`ml-auto text-[10px] px-1.5 py-0.5 rounded font-bold ${
                            pasivoSemaforo === 'red' ? 'bg-red-100 text-red-700' : 
                                        ...
                                        <tr key={p.id} className="hover:bg-slate-50">
                                            ...
                                            <td className="p-4 text-center">
                                                <span className={`px-2 py-1 rounded text-xs font-bold ${
                                                    p.status === 'PAGADO' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'
                                                }`}>
            ...
            {activeTab === 'LIABILITIES' && (
                <div>
                    ...
                    <div className={`p-6 rounded-xl border-2 mb-6 ${
                        pasivoSemaforo === 'red' ? 'bg-red-50 border-red-300' :
                        pasivoSemaforo === 'yellow' ? 'bg-yellow-50 border-yellow-300' :
                        'bg-green-50 border-green-300'
                    }`}>
                        <div className="flex items-center gap-4">
                            <div className={`p-4 rounded-xl ${
                                pasivoSemaforo === 'red' ? 'bg-red-100 text-red-600' :
                            ...
                            <div>
                                ...
                                <div className={`text-3xl font-bold ${
                                    pasivoSemaforo === 'red' ? 'text-red-700' :
