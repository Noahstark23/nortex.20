                    ...
                    <div>
                        <div className="flex flex-wrap justify-between items-center gap-3 mb-6">
                            ...
                            <div className="flex items-center gap-2">
                                <select value={dashMonth} onChange={e => setDashMonth(Number(e.target.value))} className="min-h-11 rounded-control border p-2 text-sm bg-surface-900 nx-form-field">
                                    {monthNames.map((m, i) => <option key={i} value={i + 1}>{m}</option>)}
                                </select>
                                <select value={dashYear} onChange={e => setDashYear(Number(e.target.value))} className="min-h-11 rounded-control border p-2 text-sm bg-surface-900 nx-form-field">
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                            ...
                            <div className="flex items-center gap-3">
                                <select
                                    ...
                                    className="min-h-11 rounded-control border p-2 bg-surface-900 text-slate-100 nx-form-field"
                                >
                                    {monthNames.map((m, i) => (
                                ...
                                <input
                                    ...
                                    className="min-h-11 w-24 rounded-control border p-2 bg-surface-900 text-slate-100 nx-form-field"
                                />
                                {payrolls.length > 0 && (
                                    <button
                    ...
                    <div>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                            <div className="flex flex-wrap items-center justify-between gap-3 p-4 border-b border-slate-100">
                                ...
                                <select value={holidayYear} onChange={e => setHolidayYear(Number(e.target.value))} className="min-h-11 rounded-control border p-2 text-sm bg-surface-900 nx-form-field">
                            ...
                            <form onSubmit={addHoliday} className="flex flex-wrap items-end gap-3 p-4 bg-slate-50 border-b border-slate-100">
                                <div>
                                    ...
                                    <input type="date" required value={holidayForm.date} onChange={e => setHolidayForm({ ...holidayForm, date: e.target.value })} className="block min-h-11 rounded-control border p-2 text-sm bg-surface-900 nx-form-field" />
                                </div>
                                <div className="flex-1 min-w-[160px]">
                                    <label className="text-xs font-bold text-slate-500">Nombre (fiesta local)</label>
                                    <input required value={holidayForm.name} onChange={e => setHolidayForm({ ...holidayForm, name: e.target.value })} placeholder="Ej: Fiestas patronales" className="block min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field" />
                                </div>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden mt-6">
                            <div className="flex flex-wrap items-center justify-between gap-3 p-4 border-b border-slate-100">
                                ...
                                <select value={attMonth} onChange={e => setAttMonth(Number(e.target.value))} className="min-h-11 rounded-control border p-2 text-sm bg-surface-900 nx-form-field">
                    ...
                    <div>
                        ...
                        <form onSubmit={handleCreateLeave} className="bg-white rounded-xl shadow-sm border border-slate-200 p-5 mb-6 grid sm:grid-cols-2 lg:grid-cols-5 gap-3 items-end">
                            <div>
                                ...
                                <select required value={leaveForm.employeeId} onChange={e => setLeaveForm({ ...leaveForm, employeeId: e.target.value })} className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field">
                            ...
                            <div>
                                ...
                                <select value={leaveForm.type} onChange={e => setLeaveForm({ ...leaveForm, type: e.target.value })} className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field">
                            ...
                            <div>
                                ...
                                <input type="date" required value={leaveForm.startDate} onChange={e => setLeaveForm({ ...leaveForm, startDate: e.target.value })} className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field" />
                            </div>
                            <div>
                                <label className="text-xs font-bold text-slate-500">Hasta</label>
                                <input type="date" required value={leaveForm.endDate} onChange={e => setLeaveForm({ ...leaveForm, endDate: e.target.value })} className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field" />
                            </div>
                            ...
                            <div className="sm:col-span-2 lg:col-span-5">
                                <input value={leaveForm.reason} onChange={e => setLeaveForm({ ...leaveForm, reason: e.target.value })} placeholder="Justificación (opcional)" className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field" />
                            </div>
                ...
                {activeTab === 'AGUINALDO' && (
                    <div>
                        <div className="flex flex-wrap justify-between items-center gap-3 mb-6">
                            ...
                            <div className="flex items-center gap-3">
                                <select value={aguinaldoYear} onChange={e => setAguinaldoYear(Number(e.target.value))} className="min-h-11 rounded-control border p-2 text-sm bg-surface-900 nx-form-field">
                                    {[0, 1, 2].map(d => { const yr = new Date().getFullYear() - d; return <option key={yr} value={yr}>{yr}</option>; })}
                                </select>
                    ...
                    <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg p-6 duration-200">
                        ...
                        <form onSubmit={handleCreateEmployee} className="space-y-4">
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <input required className="min-h-11 rounded-control border p-2 bg-surface-900 text-slate-100 nx-form-field" placeholder="Nombre" value={formData.firstName} onChange={e => setFormData({ ...formData, firstName: e.target.value })} />
                                <input required className="min-h-11 rounded-control border p-2 bg-surface-900 text-slate-100 nx-form-field" placeholder="Apellido" value={formData.lastName} onChange={e => setFormData({ ...formData, lastName: e.target.value })} />
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <div>
                                    ...
                                    <input
                                        className="min-h-11 w-full rounded-control border p-2 tabular-nums bg-surface-900 text-slate-100 nx-form-field"
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <div>
                                    ...
                                    <select className="min-h-11 w-full rounded-control border p-2 bg-surface-900 text-slate-100 nx-form-field" value={formData.role} onChange={e => setFormData({ ...formData, role: e.target.value })}>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        maxLength={4}
                                        required
                                        className="min-h-11 w-full rounded-control border p-2 text-center tabular-nums text-lg tracking-[0.5em] bg-surface-900 nx-form-field"
                                        placeholder="0000"
                                        value={formData.pin}
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <div>
                                    ...
                                    <input type="number" required className="min-h-11 w-full rounded-control border p-2 bg-surface-900 text-slate-100 nx-form-field" placeholder="0.00" value={formData.baseSalary} onChange={e => setFormData({ ...formData, baseSalary: e.target.value })} />
                                </div>
                                <div>
                                    <label className="text-xs font-bold text-slate-500">Comision (%)</label>
                                    <input type="number" required className="min-h-11 w-full rounded-control border p-2 bg-surface-900 text-slate-100 nx-form-field" placeholder="Ej: 5" value={formData.commissionRate} onChange={e => setFormData({ ...formData, commissionRate: e.target.value })} />
                                </div>
                            </div>
                            <div>
                                <label className="text-xs font-bold text-slate-500">Jornada (Art. 51)</label>
                                <select className="min-h-11 w-full rounded-control border p-2 bg-surface-900 text-slate-100 nx-form-field" value={formData.jornada} onChange={e => setFormData({ ...formData, jornada: e.target.value })}>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                    <div className="bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm">
                        ...
                        <input
                            ...
                            className="mb-3 w-full rounded-xl py-4 text-center tabular-nums text-3xl tracking-[0.5em] focus:border-brand focus:outline-none bg-surface-900 nx-form-field"
                            autoFocus
                        />
                    ...
                    <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="mb-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
                            <div>
                                ...
                                <select value={settlementReason} onChange={e => setSettlementReason(e.target.value)} className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field">
                            ...
                            <div>
                                ...
                                <input type="date" value={settlementDate} onChange={e => setSettlementDate(e.target.value)} className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field" />
                            </div>
                        </div>
                            ...
                            <>
                                ...
                                {showContractForm && (
                                    <form onSubmit={handleAddContract} className="bg-slate-50 border border-slate-200 rounded-xl p-4 mb-4 grid sm:grid-cols-2 gap-3">
                                        <div>
                                            <label className="text-xs font-bold text-slate-500">Tipo</label>
                                            <select value={contractForm.type} onChange={e => setContractForm({ ...contractForm, type: e.target.value })} className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field">
                                        ...
                                        <div>
                                            <label className="text-xs font-bold text-slate-500">Cargo</label>
                                            <input value={contractForm.position} onChange={e => setContractForm({ ...contractForm, position: e.target.value })} className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field" />
                                        </div>
                                        <div>
                                            <label className="text-xs font-bold text-slate-500">Inicio</label>
                                            <input type="date" required value={contractForm.startDate} onChange={e => setContractForm({ ...contractForm, startDate: e.target.value })} className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field" />
                                        </div>
                                        <div>
                                            <label className="text-xs font-bold text-slate-500">Fin (si aplica)</label>
                                            <input type="date" value={contractForm.endDate} onChange={e => setContractForm({ ...contractForm, endDate: e.target.value })} className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field" />
                                        </div>
                                        <div>
                                            <label className="text-xs font-bold text-slate-500">Fin período de prueba</label>
                                            <input type="date" value={contractForm.probationEnd} onChange={e => setContractForm({ ...contractForm, probationEnd: e.target.value })} className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field" />
                                        </div>
                                        <div>
                                            <label className="text-xs font-bold text-slate-500">Salario</label>
                                            <input type="number" required value={contractForm.salary} onChange={e => setContractForm({ ...contractForm, salary: e.target.value })} className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field" />
                                        </div>
                                ...
                                {showJudicialForm && (
                                    <form onSubmit={handleAddJudicial} className="bg-slate-50 border border-slate-200 rounded-xl p-4 mb-4 grid sm:grid-cols-2 gap-3">
                                        <div>
                                            <label className="text-xs font-bold text-slate-500">Tipo</label>
                                            <select value={judicialForm.type} onChange={e => setJudicialForm({ ...judicialForm, type: e.target.value })} className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field">
                                        ...
                                        <div>
                                            ...
                                            <input value={judicialForm.beneficiary} onChange={e => setJudicialForm({ ...judicialForm, beneficiary: e.target.value })} className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field" />
                                        </div>
                                        <div>
                                            <label className="text-xs font-bold text-slate-500">Monto fijo (C$)</label>
                                            <input type="number" value={judicialForm.amount} onChange={e => setJudicialForm({ ...judicialForm, amount: e.target.value, percentage: '' })} placeholder="0.00" className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field" />
                                        </div>
                                        <div>
                                            <label className="text-xs font-bold text-slate-500">o % del salario disponible</label>
                                            <input type="number" value={judicialForm.percentage} onChange={e => setJudicialForm({ ...judicialForm, percentage: e.target.value, amount: '' })} placeholder="0" className="min-h-11 w-full rounded-control border p-2 text-sm bg-surface-900 nx-form-field" />
                                        </div>
                                        <div className="sm:col-span-2 flex gap-2">
                                ...
                                {expediente.linkedUser ? (
                                    ...
                                    <div className="flex flex-wrap items-center gap-2">
                                        <select value={linkUserId} onChange={e => setLinkUserId(e.target.value)} className="min-h-11 min-w-[180px] flex-1 rounded-control border p-2 text-sm bg-surface-900 nx-form-field">
