                    ...
                    <fieldset disabled={Boolean(busy)} role="dialog" aria-modal="true" aria-labelledby="new-po-title" className="min-w-0 bg-slate-900 border border-slate-700 rounded-xl w-full max-w-lg p-5 space-y-4 max-h-[90vh] overflow-y-auto" onClick={event => event.stopPropagation()}>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="mt-1 w-full px-3 py-2.5 border rounded-control text-sm disabled:text-slate-500 bg-surface-900 nx-form-field"
                            >
                    ...
                    <fieldset disabled={Boolean(busy)} role="dialog" aria-modal="true" aria-labelledby="receive-po-title" className="min-w-0 bg-slate-900 border border-slate-700 rounded-xl w-full max-w-xl p-5 space-y-4 max-h-[90vh] overflow-y-auto" onClick={event => event.stopPropagation()}>
                        ...
                        <div className="rounded-lg border border-emerald-500/20 bg-emerald-500/5 p-3">
                            ...
                            <select
                                ...
                                className="w-full rounded-control border px-3 py-2.5 text-sm focus:border-emerald-500 focus:outline-none disabled:opacity-60 bg-surface-900 nx-form-field"
                            >
                                <option value="">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full rounded-control border px-3 py-2.5 text-sm focus:border-emerald-500 focus:outline-none bg-surface-900 nx-form-field"
                            />
                        </div>
                                        ...
                                        <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    inputMode="decimal"
                                                    placeholder="0"
                                                    className="w-full rounded border border-emerald-800/70 px-2 py-2 text-right font-mono bg-surface-900 rounded-control nx-form-field"
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    inputMode="decimal"
                                                    placeholder="0"
                                                    className="w-full rounded border border-red-800/70 px-2 py-2 text-right font-mono bg-surface-900 rounded-control nx-form-field"
                                                    disabled={pending.lessThanOrEqualTo(0)}
                                        ...
                                        <div className="mt-3 rounded-lg border border-red-500/20 bg-red-500/5 p-3">
                                            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                                <div>
                                                    ...
                                                    <select
                                                        ...
                                                        className="w-full rounded border border-red-800/70 px-2.5 py-2 text-sm bg-surface-900 rounded-control nx-form-field"
                                            ...
                                            <div className="mt-3">
                                                ...
                                                <textarea
                                                    ...
                                                    maxLength={1000}
                                                    rows={2}
                                                    className="w-full rounded border px-2.5 py-2 text-sm bg-surface-900 rounded-control nx-form-field"
                                        ...
                                        <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-2">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full px-2.5 py-2 border border-orange-800/70 rounded text-sm bg-surface-900 rounded-control nx-form-field"
                                                />
                                            </div>
                                            <div>
                    ...
                    <div role="dialog" aria-modal="true" aria-labelledby="close-short-title" className="max-h-[90vh] w-full max-w-2xl space-y-4 overflow-y-auto rounded-xl border border-orange-500/30 bg-slate-900 p-5" onClick={event => event.stopPropagation()}>
                        ...
                        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full rounded-control border px-3 py-2.5 text-sm bg-surface-900 nx-form-field"
                                >
                                            ...
                                            <div className="grid grid-cols-1 gap-3 sm:grid-cols-[minmax(0,1fr)_9rem]">
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-full rounded border border-orange-700/60 px-2 py-2 text-right font-mono bg-surface-900 rounded-control nx-form-field"
                                            ...
                                            <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2">
                                                <div>
                                                    ...
                                                    <select
                                                        ...
                                                        className="w-full rounded border border-orange-700/60 px-2.5 py-2 text-sm bg-surface-900 rounded-control nx-form-field"
                        ...
                        <label className="flex cursor-pointer items-start gap-3 rounded-lg border border-orange-500/25 bg-orange-500/5 p-3 text-sm text-orange-100">
                            <input
                                ...
                                className="mt-0.5 h-4 w-4 rounded bg-surface-900 text-slate-100 border rounded-control nx-form-field"
                            />
