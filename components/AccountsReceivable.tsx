        ...
        {showPayModal && (
          <div className="absolute inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
              <div className="bg-nortex-900 p-6 text-white">
                <h3 className="text-lg font-bold">Registrar Abono</h3>
                <p className="text-nortex-400 text-sm">Cliente: {selectedSale?.customerName}</p>
              </div>
              <form onSubmit={handleRegisterPayment} className="p-6">
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      type="number" 
                      step="0.01"
                      className="w-full pl-10 pr-4 py-3 text-2xl font-bold text-slate-900 border border-slate-300 rounded-lg focus:ring-2 focus:ring-nortex-500 focus:border-nortex-500 outline-none"
                      placeholder="0.00"
                      value={paymentAmount}
                  ...
                  <div className="text-right mt-1 text-xs text-slate-500">
                    Máximo a cobrar: <span className="font-bold">${selectedSale?.balance.toFixed(2)}</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                   <button 
                     ...
                     className="py-3 px-4 rounded-xl border border-slate-300 font-medium text-slate-600 hover:bg-slate-50"
                   >
                     Cancelar
                   </button>
                   <button 
                     type="submit" 
                     className="py-3 px-4 rounded-xl bg-nortex-500 font-bold text-white hover:bg-nortex-400 shadow-lg shadow-nortex-500/30"
                   >
                     Confirmar Pago
                   </button>
                </div>
