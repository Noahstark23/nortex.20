...
const LandingFarmacia: React.FC = () => {
  const registerUrl = '/register?type=FARMACIA&source=landing_farmacia';
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800">
      ...
      <section className="pt-32 pb-20 px-6 max-w-5xl mx-auto text-center">
        <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6 leading-tight">
          ...
          <span className="text-emerald-600">para Farmacias en Nicaragua</span>
        </h1>
        <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-10 leading-relaxed">
          Controla tu stock al detalle, factura cumpliendo la DGI, 
          y gestiona a tus vendedores desde una sola pantalla. 
          Diseñado específicamente para el ritmo de una farmacia nicaragüense.
        </p>
      ...
      <section className="py-16 bg-white border-y border-slate-100">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center text-slate-900 mb-12">
            Los problemas que resuelve Nortex en tu farmacia
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            {[
              {
                icon: <Package size={24} />,
                title: "Inventario de medicamentos sin errores",
                desc: "Gestiona medicamentos, cosméticos y productos de salud con códigos de barras y alertas automáticas de stock mínimo. Nunca más 'ya se nos acabó'."
              },
              {
                icon: <Zap size={24} />,
                title: "Ventas rápidas en el mostrador",
                desc: "POS optimizado para velocidad: busca productos por nombre, código o categoría. Escáner de código de barras integrado. Cobra en efectivo o tarjeta en segundos."
              },
              {
              ...
              {
                icon: <Users size={24} />,
                title: "Control de dependientes y comisiones",
                desc: "Asigna metas a cada dependiente, calcula comisiones automáticamente, y ve en tiempo real quién está vendiendo más. Gestión de nómina incluida."
              }
            ].map((item, i) => (
      ...
      <section className="py-16 max-w-5xl mx-auto px-6">
        <h2 className="text-2xl font-bold text-slate-900 mb-8">
          Todo lo que necesita tu farmacia en Nicaragua
        </h2>
      ...
      <section className="py-20 bg-slate-900 text-white text-center px-6">
        ...
        <p className="text-slate-300 mb-8 max-w-2xl mx-auto">
          Cientos de farmacias en Nicaragua ya usan Nortex. 
      ...
      <footer className="py-8 bg-slate-800 text-slate-400 text-center text-sm">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="mt-3 flex justify-center gap-6">
            ...
            <Link to="/ferreterias" className="hover:text-white">Para Ferreterías</Link>
