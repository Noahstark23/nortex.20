import { createAssistantWorkItemsRouter } from './assistantWorkItems.js';
...
export function mountAssistantRoutes(app: Express) {
  ...
  app.use('/api/assistant', createAssistantKnowledgeRouter());
  app.use('/api/assistant', buildAssistantDocumentsRouter());
  app.use('/api/assistant', createAssistantOperationsRouter());
  app.use('/api/assistant', createAssistantWorkItemsRouter());
