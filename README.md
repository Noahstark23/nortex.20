...
Nortex construye un equipo administrativo accesible para comercios de Nicaragua: contabilidad, recursos humanos y finanzas sobre un ERP/POS multi-tenant. La aplicación usa React/PWA, Express, Prisma y MySQL 8.

La dirección del 2026-09-19 prioriza completar trabajos verificables con agentes, empezando por una revisión semanal de caja que se pueda guardar, retomar y aceptar. El POS conserva rapidez y carrito. Ferretería y farmacia siguen siendo las primeras verticales; implementación, QA, modelo, piloto y producción se acreditan por separado.

## Empezar por aquí

- [Meta del equipo administrativo](docs/META_NORTEX_EQUIPO_ADMINISTRATIVO.md): resultado, alcance y economía.
- [Roadmap de agentes](docs/ROADMAP_AGENTES_NORTEX.md): orden, entregas y condiciones para avanzar.
- [Reglas de agentes](docs/REGLAS_AGENTES_NORTEX.md) y [arquitectura](docs/ARQUITECTURA_AGENTES_NORTEX.md): autoridad, trabajo durable y contratos.
- [Estado verificable](docs/ESTADO_ACTUAL_NORTEX.md): diferencias entre este checkout, candidatos y evidencia; no hay una única copia consolidada.
- [Plan de transformación](docs/PLAN_TRANSFORMACION_TOTAL_2026.md): backlog de base que se conserva bajo la dirección actual.
...
El candidato aislado del 19/09 incorpora fuentes y biblioteca editorial autenticada; no está integrado por esta edición documental. Los doce textos LEGACY y la colección nueva pendiente de revisión son estados distintos. [Procedencia y límites](docs/ESTADO_ACTUAL_NORTEX.md).
