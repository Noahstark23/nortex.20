...
- Verificar [procedencia](docs/ESTADO_ACTUAL_NORTEX.md): este checkout y los
  candidatos aislados contienen cambios distintos. No atribuir código o QA de uno
  al otro ni reemplazar guías enteras perdiendo reglas actuales.
