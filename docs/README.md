...
Actualización de dirección: **2026-09-19**. Nortex busca completar trabajo administrativo con agentes de contabilidad, RRHH y finanzas, conservando venta rápida y un núcleo confiable. Un documento de diseño no acredita implementación, despliegue ni uso efectivo.

## Ruta de lectura vigente

1. [Meta del equipo administrativo](META_NORTEX_EQUIPO_ADMINISTRATIVO.md): qué resultado buscamos y para quién.
2. [Roadmap de agentes](ROADMAP_AGENTES_NORTEX.md): W01 durable primero, W02/W03, MCP y coordinación; compras/RAG en paralelo.
3. [Reglas](REGLAS_AGENTES_NORTEX.md) y [arquitectura](ARQUITECTURA_AGENTES_NORTEX.md): autoridad, estados, confirmación y recuperación.
4. [Estado verificable](ESTADO_ACTUAL_NORTEX.md): fuente/candidato, implementación, QA, revisión humana y despliegue separados.
5. [Equipo de desarrollo](EQUIPO_DESARROLLO_NORTEX.md) y [ficha de trabajo](templates/CONTRATO_TRABAJO_AGENTE.md): responsabilidades y criterios por lote.
6. [Compras H01](CONTRATO_COMPRAS_CONVERSACIONALES_H01.md): conductas A/B/C aceptadas y brechas técnicas pendientes.
7. [Entrega documental](ENTREGA_META_AGENTES_2026-09-19.md): archivos y comprobaciones de esta actualización.

## Dirección y evidencia actual

**Evidencia histórica del 04/09:** [Reparación de prioridades y verificación por módulo](VERIFICACION_MODULOS_2026-09-04.md). Estado E01–E08, dinero/stock/permisos, QA MySQL, navegador y pendientes M01–M07 de ese corte. Conserva el [rediseño aceptado](REDISENO_POS_2026-09-04.md). Las entregas posteriores se identifican en el estado verificable, sin reescribir aquel resultado.

1. [Plan de transformación](PLAN_TRANSFORMACION_TOTAL_2026.md): hipótesis comerciales y backlog T00–T19 conservados; la meta y el roadmap actuales fijan prioridad.
...
La meta y el roadmap deciden prioridades; los planes de dominio conservan el detalle y sus IDs; AGENTS/CLAUDE mantienen reglas de ingeniería. Consultar la [matriz de mantenimiento](REGLAS_AGENTES_NORTEX.md) antes de modificar recetas. Si se contradicen hechos, verificar código y registrar la decisión. Ningún informe puede declarar seguridad o cumplimiento global por una prueba parcial.
