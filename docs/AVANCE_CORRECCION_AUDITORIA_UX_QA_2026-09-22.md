...
| #12 Fondo C$ 200 | Contrato actual demostrado; observación histórica sin causa | Abrir turno con fondo persiste `initialCash`, auditoría y lectura en caja/monitor en la misma prueba de integración. El POS ahora acusa el turno y el fondo que devolvió el servidor. No hay solicitud, respuesta ni `shiftId` de la observación en producción para concluir por qué se vieron cero córdobas. |
