...
**Estado: plan de desarrollo reconciliado con el candidato `484f58a`; implementación y pendientes separados. Actualización: 2026-09-08.**
...
|---|---|
| Recuperación / Infraestructura | El respaldo SQL externo ya tiene metadata y hash concordantes; falta acreditar cobertura de originales y restaurar en un entorno aislado con ejecución, envíos y cobros apagados. Conciliar hashes, referencias y operaciones; medir tiempo de recuperación y pérdida máxima de datos. La existencia de un backup o snapshot no prueba restauración. |
