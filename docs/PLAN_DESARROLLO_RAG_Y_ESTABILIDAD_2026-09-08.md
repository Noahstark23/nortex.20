...
> **Actualización de dirección, 2026-09-19:** conservar C00/D00–D14 como backlog
> técnico de la [meta administrativa](META_NORTEX_EQUIPO_ADMINISTRATIVO.md).
> El [roadmap](ROADMAP_AGENTES_NORTEX.md) ordena W01 durable y frentes paralelos.
> D01/D03/editor tienen evidencia local posterior; D02 sigue pendiente de revisión
> completa/publicación. H01 A/B/C valida conductas, no esos artículos. Consultar
> [estado y procedencia](ESTADO_ACTUAL_NORTEX.md) antes de repetir trabajo.
> Comparaciones, precios de proveedor e infraestructura de este informe conservan
> su fecha de observación; no fueron revalidados en esta actualización documental.
...
- Política posterior: US$2 iniciales por negocio/mes, aumento por solicitud del dueño y aprobación de Nortex hasta US$10; US$20/mes totales. El tope QA observado de US$5 pertenece a su entorno histórico, no añade presupuesto. El candidato con aprobaciones aún requiere consolidación en este checkout; verificar código/configuración antes de habilitar llamadas. El precio objetivo de US$20 del servicio no es un cupo de IA.
