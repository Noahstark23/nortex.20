...
| SQL y originales | Copia remota coherente y restore aislado con referencias, hashes, permisos, compra y propuesta reconciliados | Parcial: ensayos locales sintéticos de 143 tablas/228 filas y 143 tablas/229 filas; original, compra y propuesta `COMMITTED` reconciliados; alteración de archivo y referencia detectadas. No existe prueba de copia remota conjunta ni restore de producción; extracción sigue apagada |
