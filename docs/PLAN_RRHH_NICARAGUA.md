...
> **Prioridad del 2026-09-19:** este dominio alimenta W02, planilla preparada y
> revisada, de la [meta administrativa](META_NORTEX_EQUIPO_ADMINISTRATIVO.md).
> Seguir el [roadmap](ROADMAP_AGENTES_NORTEX.md): separar cálculo de persistencia,
> privacidad por campo y reglas vigentes revisadas; pago en lote transaccional
> separado. El HRIS completo conserva su backlog, sin preceder al primer W01 útil.
