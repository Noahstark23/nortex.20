...
**A00 reunido; H01-1/2 y A01.W01.1–2 implementados localmente.**

La [entrega actual](NORTEXGPT_ENTREGA_PREPARACION_2026-09-19.md) reúne presupuesto,
W01/W01B, editorial e identidad sobre main `67f1832…`, con parche y manifiesto.
La consolidación no acredita promoción ni cierra W01 completo.

1. Cerrar la integración real del candidato: persistencia/reinicio de encargos,
   concurrencia, schema/upgrade, presupuesto y compuerta financiera pendiente.
   La revisión automática previa sigue bloqueando el reintento de esa compuerta;
   ninguna suite simulada o CI disparada como alternativa la sustituye.
2. Completar A02.W01.3–4: informe y excepciones versionados, revalidación de fuentes,
   aceptación exacta y continuidad móvil/escritorio con carrito conservado.
3. Revisar artículos/expected y evaluar modelo real de forma acotada; medir utilidad
   por vertical antes de habilitar al cliente. El trabajo guardado no equivale a
   una revisión contable terminada ni a una corrección registrada.
4. Resolver destino staging y proceder con un nuevo SHA, CI, staging y recuperación
   acreditados conforme al runbook; producción conserva autorización propia.
...
| H01-2 | Implementado en candidato reunido: fuentes y resolución explícita, recuperación por versión | Regresión 50/40 y QA determinista aprobadas; integración financiera/modelo real pendientes |
...
| D01/D03 | Citas/biblioteca/editor consolidados; revocación parcial comprobada en QA determinista | Publicación humana y MySQL del conjunto pendientes. Salir de SuperAdmin puede perder un borrador editorial sin enviar |
...
H01-1/2 y A01.W01.1–2 está registrada en la entrega actual, sin cambiar flags ni
iniciar llamadas pagadas. Las fechas se estiman por lote después
