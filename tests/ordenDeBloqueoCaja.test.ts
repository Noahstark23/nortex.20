 ...
 *
 * Dos transacciones del sistema bloquean las MISMAS dos tablas:
 ...
 * devolución era Shift → Product. No lo es — su lock del turno vive dentro del
 * bloque de reembolso CASH, después del bucle de stock.
 *
